...
export default function RoadmapHeader({ onStartLearning }: RoadmapHeaderProps) {
  const { userGoal, timeline } = useUser();

  // Default goal and timeline if none are set
  const displayGoal = userGoal || "SDE-1 Interview Preparation for Google";
  const displayTimeline = timeline || "30 Days";
  return (
    <div className="mb-8">
