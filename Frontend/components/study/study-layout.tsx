...
export default function StudyLayout({
  ...
  const [chatMessages, setChatMessages] = useState<{type: 'user' | 'ai', content: string}[]>([{type: 'ai', content: "Hi there! I'm your AI study assistant. How can I help you today?"}]);
    ...
    <div className="min-h-screen flex flex-col">
          ...
          <div className="flex items-center space-x-4">
            <Button 
              ...
              className={cn(
                ...
                aiChatOpen && "bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-900/20 dark:text-blue-300 dark:border-blue-800"
              )}
            >
      ...
      <div className="flex flex-1 overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto" style={{ overscrollBehavior: 'contain' }}>
                <nav className="p-2 space-y-2">
                  {Object.entries(groupedTopics).map(([day, dayTopics]) => (
                    <div key={day} className="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow transition-shadow">
                      <button 
          ...
          <div className="hidden md:flex border-l border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 z-20 w-[380px] flex-col h-[calc(100vh-4rem)] fixed right-0 top-16">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4" style={{ overscrollBehavior: 'contain' }}>
              {chatMessages.map((message, index) => (
                <div 
                  key={index} 
                  className={`${message.type === 'ai' ? 'bg-gray-100 dark:bg-gray-800' : 'bg-blue-100 dark:bg-blue-900 ml-auto'} rounded-lg p-3 max-w-[85%]`}
                >
        ...
        {aiChatOpen && (
          <>
            {/* Mobile overlay */}
            <div className="md:hidden fixed inset-0 bg-black/50 z-30" onClick={() => setAiChatOpen(false)} />
